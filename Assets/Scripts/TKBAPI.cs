...
namespace TKBAPI
{
    ...
    public class VectorAPI : MonoBehaviour
    {
        ...
        public static void constrain_3d_min_dist(ref Vector3 pos1, ref Vector3 pos2, float desired_dist, float compensate1, float compensate2)

        {
            ...
            if (deltalength > 0 && deltalength < desired_dist)
        ...
        public static void constrain_3d_range_dist(ref Vector3 pos1, ref Vector3 pos2, float desired_min, float desired_max, float compensate1, float compensate2)

        {
            ...
            if (deltalength > 0 && deltalength < desired_min)

            {

                float diff = (deltalength - desired_min) / deltalength;
            ...
            else if (deltalength > desired_max)

            {

                float diff = (deltalength - desired_max) / deltalength;
